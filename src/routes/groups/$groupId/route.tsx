...
function GroupRoute() {
  ...
  // Keyed on the param so that every piece of state below is thrown away when
  // the group changes. Without it, navigating between groups paints the new
  // group's name over the previous group's bills for as long as the reads take.
  return <GroupLayout key={groupId} groupId={groupId} />
}
 ...
 */
function GroupLayout({ groupId }: { groupId: string }) {
